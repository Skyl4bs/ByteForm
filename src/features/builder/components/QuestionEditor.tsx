...
export const QuestionEditor = memo(QuestionEditorInner);

function WelcomeScreenEditorInner({ screen, onUpdate }: WelcomeEditorProps) {
  return (
    <div className="space-y-5">
      <div>
...
export const WelcomeScreenEditor = memo(WelcomeScreenEditorInner);

function ThankYouScreenEditorInner({ screen, onUpdate }: ThankYouEditorProps) {
  return (
    <div className="space-y-5">
      <div>
        <FieldLabel>Title</FieldLabel>
...
export const ThankYouScreenEditor = memo(ThankYouScreenEditorInner);
