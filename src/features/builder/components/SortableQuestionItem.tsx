...
import { getTypeInfo } from "@/shared/lib/question-types";
...
function SortableQuestionItemInner({
  question,
  index,
  isSelected,
  onSelect,
  ...
  const handleSelect = useCallback(() => onSelect(question.id), [onSelect, question.id]);
  const handleDelete = useCallback(
    (e: React.MouseEvent) => { e.stopPropagation(); onDelete(question.id); },
    [onDelete, question.id]
  );
  const handleDuplicate = useCallback(
    (e: React.MouseEvent) => { e.stopPropagation(); onDuplicate(question.id); },
...
export const SortableQuestionItem = memo(SortableQuestionItemInner);
